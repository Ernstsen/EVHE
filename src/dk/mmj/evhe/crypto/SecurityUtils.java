...
public class SecurityUtils {
    ...
    public static BigInteger generateLagrangeCoefficient(int[] authorityIndexes, int currentIndex, BigInteger p) {
        BigInteger lagrangeCoefficient = BigInteger.ONE;
        BigInteger currentIndexBig = BigInteger.valueOf(currentIndex);

        for (int i = 0; i < authorityIndexes.length; i++) {
            if (authorityIndexes[i] != currentIndex) {
